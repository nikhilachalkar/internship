...
const [password, setPassword] = useState('');
  ...
  <div className="about-content">
    <div className="about-text">
      <h2>About Us</h2>
      <p>
        Swami Pharma is a leading provider of high-quality pharmaceutical solutions, committed to ensuring community well-being through innovation, reliability, and trust.
        We offer a wide range of medicines, efficient inventory systems, and customer-focused healthcare services to meet your pharmacy needs.
      </p>
      <p>
        Our mission is to ensure access to essential healthcare products, with timely support and data-driven tools that help pharmacies thrive.
      </p>
    </div>
...
{showRegister && (
  <div className="modal">
    <div className="modal-content">
      ...
      <p>Already have an account? <span className="link" onClick={() => { setShowRegister(false); setShowLogin(true); }}>Login</span></p>
    </div>
  </div>
)}
